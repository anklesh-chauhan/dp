...
use App\Domain\Shared\Services\ProcessPostgresDumpRunner;
use App\Domain\Shared\Services\ProcessPostgresRestoreRunner;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(PostgresDumpRunner::class, ProcessPostgresDumpRunner::class);
        $this->app->bind(PostgresRestoreRunner::class, ProcessPostgresRestoreRunner::class);
