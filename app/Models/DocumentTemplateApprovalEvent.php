...
class DocumentTemplateApprovalEvent extends Model implements ElectronicSignatureRecord
{
    ...
    {
        self::updating(fn () => throw new LogicException('Document template approval events are append-only.'));
        self::deleting(fn () => throw new LogicException('Document template approval events are append-only.'));
    }
