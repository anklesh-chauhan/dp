...
class DocumentVariableRelationManager extends RelationManager
{
    ...
    public function form(Schema $schema): Schema
    {
        return $schema
            ->columns(1)
            ->components(fn (?ControlledDocumentVariable $record): array => [
                Grid::make(2)->schema([
     ...
     */
    private function valueFields(?ControlledDocumentVariable $record): array
    {
    ...
    private function resolveTemplateVariable(?ControlledDocumentVariable $record): ?DocumentTemplateVariable
    {
        if ($record === null) {
            return null;
        }
