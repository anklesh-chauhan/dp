            ...
            ->components([
                Section::make('Organization')->schema([
                    Grid::make(3)->schema([
                        ...
                        TextEntry::make('date_display_format')->label('Date format'),
                        TextEntry::make('datetime_display_format')->label('Date and time format'),
                        TextEntry::make('time_display_format')->label('Time format'),
                    ]),
