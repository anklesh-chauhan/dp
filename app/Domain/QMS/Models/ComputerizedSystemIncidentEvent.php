...
final class ComputerizedSystemIncidentEvent extends Model implements ElectronicSignatureRecord, HasSignatureContentDigest
{
    ...
    protected $fillable = [
        'incident_id', 'event_uuid', 'from_status', 'to_status', 'actor_id', 'reason', 'context',
        'signature_hash', 'signature_ip_address', 'signature_user_agent', 'occurred_at',
    ];

    protected static function booted(): void
    {
        self::updating(fn () => throw new LogicException('Computerized system incident events are append-only.'));
        self::deleting(fn () => throw new LogicException('Computerized system incident events are append-only.'));
    }
    ...
    {
        return [
            'from_status' => ComputerizedSystemIncidentStatus::class,
            'to_status' => ComputerizedSystemIncidentStatus::class,
            'context' => 'array',
            'occurred_at' => 'immutable_datetime',
        ];
    }

    /** @return BelongsTo<ComputerizedSystemIncident, $this> */
    public function incident(): BelongsTo
    {
        return $this->belongsTo(ComputerizedSystemIncident::class, 'incident_id');
    }
