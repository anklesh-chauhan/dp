...
use App\Models\User;
use Database\Factories\Domain\QMS\Models\EquipmentMaintenanceEventFactory;
...
final class EquipmentMaintenanceEvent extends Model implements ElectronicSignatureRecord, HasSignatureContentDigest
{
    /** @use HasFactory<EquipmentMaintenanceEventFactory> */
    use HasFactory;
    ...
    {
        self::updating(fn () => throw new LogicException('Equipment maintenance events are append-only.'));
        self::deleting(fn () => throw new LogicException('Equipment maintenance events are append-only.'));
    }
    ...
    {
        return [
            'from_status' => EquipmentMaintenanceStatus::class,
            'to_status' => EquipmentMaintenanceStatus::class,
            'context' => 'array',
            'occurred_at' => 'immutable_datetime',
        ];
    }

    /** @return BelongsTo<EquipmentMaintenance, $this> */
