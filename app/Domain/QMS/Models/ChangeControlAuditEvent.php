...
use App\Models\User;
use Database\Factories\Domain\QMS\Models\ChangeControlAuditEventFactory;
use Illuminate\Database\Eloquent\Factories\HasFactory;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Database\Eloquent\Relations\BelongsTo;
use LogicException;

final class ChangeControlAuditEvent extends Model implements ElectronicSignatureRecord, HasSignatureContentDigest
{
    /** @use HasFactory<ChangeControlAuditEventFactory> */
    use HasFactory;
    ...
    {
        self::updating(fn () => throw new LogicException('Change control audit events are append-only.'));
        self::deleting(fn () => throw new LogicException('Change control audit events are append-only.'));
    }
    ...
    {
        return [
            'from_status' => ChangeControlStatus::class,
            'to_status' => ChangeControlStatus::class,
            'context' => 'array',
