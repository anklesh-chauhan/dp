...
use App\Models\User;
use Database\Factories\Domain\QMS\Models\ManagementReviewEventFactory;
...
final class ManagementReviewEvent extends Model implements ElectronicSignatureRecord, HasSignatureContentDigest
{
    /** @use HasFactory<ManagementReviewEventFactory> */
    use HasFactory;
    ...
    protected $fillable = [
        'event_uuid', 'management_review_id', 'from_status', 'to_status', 'actor_id',
    ...
    {
        self::updating(fn () => throw new LogicException('Management review events are append-only.'));
        self::deleting(fn () => throw new LogicException('Management review events are append-only.'));
    }
    ...
    {
        return [
            'from_status' => ManagementReviewStatus::class,
            'to_status' => ManagementReviewStatus::class,
            'context' => 'array',
