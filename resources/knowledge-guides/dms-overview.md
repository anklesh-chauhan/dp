...
Help content for this module is listed under **DMS · Help & Knowledge → Knowledge Library**.
...
| SOP Administrator | Administer DMS configuration, permissions, and operations. |

Use different accounts for authoring, checking, approving, execution, production review, and QA disposition when separation of duties applies.
