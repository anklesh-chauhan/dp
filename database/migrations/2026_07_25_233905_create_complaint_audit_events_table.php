...
return new class extends Migration
{
    ...
    {
        Schema::create('complaint_audit_events', function (Blueprint $table) {
            $table->id();
            ...
            $table->index(['complaint_id', 'occurred_at'], 'complaint_audit_timeline_index');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('complaint_audit_events');
    }
};
