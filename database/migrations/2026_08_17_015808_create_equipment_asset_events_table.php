...
return new class extends Migration
{
    ...
    {
        Schema::create('equipment_asset_events', function (Blueprint $table) {
            $table->id();
            ...
            $table->index(['equipment_asset_id', 'occurred_at'], 'equipment_asset_event_timeline_index');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('equipment_asset_events');
    }
};
