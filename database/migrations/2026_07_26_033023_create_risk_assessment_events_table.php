...
return new class extends Migration
{
    ...
    {
        Schema::create('risk_assessment_events', function (Blueprint $table) {
            $table->id();
            ...
            $table->index(['risk_assessment_id', 'occurred_at'], 'risk_assessment_timeline_index');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('risk_assessment_events');
    }
};
