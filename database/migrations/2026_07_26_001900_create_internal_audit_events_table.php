...
return new class extends Migration
{
    ...
    {
        Schema::create('internal_audit_events', function (Blueprint $table) {
            $table->id();
            ...
            $table->index(['internal_audit_id', 'occurred_at'], 'internal_audit_timeline_index');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('internal_audit_events');
    }
};
