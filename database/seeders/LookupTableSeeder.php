...
class LookupTableSeeder extends Seeder
{
    ...
    {
        $types = [
            ['code' => 'SOP', 'name' => 'Standard Operating Procedure', 'requires_sop_reference' => false, 'is_issuable' => false],
            ['code' => 'LOG', 'name' => 'Log Document', 'requires_sop_reference' => true, 'is_issuable' => true],
            ['code' => 'BMR', 'name' => 'Batch Manufacturing Record', 'requires_sop_reference' => true, 'is_issuable' => true],
            ['code' => 'FORM', 'name' => 'Controlled Form', 'requires_sop_reference' => true, 'is_issuable' => true],
            ['code' => 'REPORT', 'name' => 'Report', 'requires_sop_reference' => true, 'is_issuable' => true],
            ['code' => 'PROTOCOL', 'name' => 'Protocol', 'requires_sop_reference' => true, 'is_issuable' => true],
            ['code' => 'SPEC', 'name' => 'Specification', 'requires_sop_reference' => true, 'is_issuable' => true],
            ['code' => 'VALIDATION', 'name' => 'Validation', 'requires_sop_reference' => true, 'is_issuable' => true],
