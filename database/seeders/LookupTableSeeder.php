...
class LookupTableSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $this->seedLookup(VariableDataType::class, [
            ...
            [VariableDataType::TEXTAREA, 'Textarea', 2],
            [VariableDataType::NUMBER, 'Number', 3],
            [VariableDataType::DATE, 'Date', 4],
            [VariableDataType::SELECT, 'Select', 5],
            [VariableDataType::BOOLEAN, 'Boolean', 6],
            [VariableDataType::USER, 'User', 7],
            [VariableDataType::DEPARTMENT, 'Department', 8],
            [VariableDataType::SOP_REFERENCE, 'SOP Reference', 9],
        ]);
